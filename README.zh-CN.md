...
- 项目 Release：https://github.com/sunfhs/yomiepub-studio/releases/tag/v0.1.0
...
- macOS：双击 `start_yomiepub.command`
...
1. 创建本地 Python 环境 `.venv`
2. 在你的电脑里安装 YomiEpub Studio
3. 启动本地网页服务
4. 自动打开 `http://127.0.0.1:8765`

使用网页时，请保持启动器窗口不要关闭。关闭窗口或按 `Ctrl+C`，本地服务就会停止。

如果 macOS 提示“无法打开，因为来自未知开发者”：

1. 右键点击 `start_yomiepub.command`
2. 选择 **打开**
3. 再确认一次 **打开**
